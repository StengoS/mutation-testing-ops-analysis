...
def main():
    ...
    for run_id in range(1, 6):
        ...
        # Randomize ordering of test cases for orthogonal() in Vector3D.java
        ...
        # orthogonal() test cases' file name: Vector3D_orthogonalTest; Unit test name: testOrthogonal<#>
        test_suite_info = get_cases_full_conditional_cov("-Dtest=Vector3D_orthogonalTest#", "testOrthogonal", \
            test_cases_original, "orthogonal", shuffled_cases, mute_print=False)
        ...
        mutations_info = parse_mutation_matrix("mutation_matrix/mutations.xml", test_cases_picked,
            mute_print=False, start_line=262, end_line=279)
