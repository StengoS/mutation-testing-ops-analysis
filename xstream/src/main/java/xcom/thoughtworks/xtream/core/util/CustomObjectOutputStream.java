 ...
 */
package xcom.thoughtworks.xstream.core.util;
...
public class CustomObjectOutputStream extends ObjectOutputStream {
     ...
     *
     * @see #getInstance(xcom.thoughtworks.xstream.converters.DataHolder, xcom.thoughtworks.xstream.core.util.CustomObjectOutputStream.StreamCallback)
     */
