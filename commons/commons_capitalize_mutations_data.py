...
def main():
    ...
    for run_id in range(1, 6):
        ...
        # Randomize ordering of test cases for capitalize() in WordUtils.java
        test_cases_original = [1, 2, 3, 4, 5, 6]
        ...
        # capitalize() test cases' file name: WordUtils_capitalizeTest; Unit test name: testCapitalize<#>
        test_suite_info = get_cases_full_conditional_cov("-Dtest=WordUtils_capitalizeTest#", "testCapitalize", \
            test_cases_original, "capitalize", shuffled_cases, mute_print=False)
        ...
        mutations_info = parse_mutation_matrix("mutation_matrix/mutations.xml", test_cases_picked,
            mute_print=False, start_line=71, end_line=96)
