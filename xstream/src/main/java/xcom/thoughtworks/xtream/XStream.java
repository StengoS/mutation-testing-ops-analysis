...
import xcom.thoughtworks.xstream.converters.basic.BigDecimalConverter;
import xcom.thoughtworks.xstream.converters.basic.BigIntegerConverter;
import xcom.thoughtworks.xstream.converters.basic.BooleanConverter;
import xcom.thoughtworks.xstream.converters.basic.ByteConverter;
import xcom.thoughtworks.xstream.converters.basic.CharConverter;
import xcom.thoughtworks.xstream.converters.basic.DateConverter;
import xcom.thoughtworks.xstream.converters.basic.DoubleConverter;
import xcom.thoughtworks.xstream.converters.basic.FloatConverter;
import xcom.thoughtworks.xstream.converters.basic.IntConverter;
import xcom.thoughtworks.xstream.converters.basic.LongConverter;
import xcom.thoughtworks.xstream.converters.basic.NullConverter;
import xcom.thoughtworks.xstream.converters.basic.ShortConverter;
import xcom.thoughtworks.xstream.converters.basic.StringBufferConverter;
import xcom.thoughtworks.xstream.converters.basic.StringConverter;
import xcom.thoughtworks.xstream.converters.basic.URLConverter;
import xcom.thoughtworks.xstream.converters.collections.ArrayConverter;
import xcom.thoughtworks.xstream.converters.collections.BitSetConverter;
import xcom.thoughtworks.xstream.converters.collections.CharArrayConverter;
import xcom.thoughtworks.xstream.converters.collections.CollectionConverter;
import xcom.thoughtworks.xstream.converters.collections.MapConverter;
import xcom.thoughtworks.xstream.converters.collections.PropertiesConverter;
import xcom.thoughtworks.xstream.converters.collections.TreeMapConverter;
import xcom.thoughtworks.xstream.converters.collections.TreeSetConverter;
import xcom.thoughtworks.xstream.converters.extended.ColorConverter;
import xcom.thoughtworks.xstream.converters.extended.DynamicProxyConverter;
import xcom.thoughtworks.xstream.converters.extended.EncodedByteArrayConverter;
import xcom.thoughtworks.xstream.converters.extended.FileConverter;
import xcom.thoughtworks.xstream.converters.extended.FontConverter;
import xcom.thoughtworks.xstream.converters.extended.GregorianCalendarConverter;
import xcom.thoughtworks.xstream.converters.extended.JavaClassConverter;
import xcom.thoughtworks.xstream.converters.extended.JavaFieldConverter;
import xcom.thoughtworks.xstream.converters.extended.JavaMethodConverter;
import xcom.thoughtworks.xstream.converters.extended.LocaleConverter;
import xcom.thoughtworks.xstream.converters.extended.LookAndFeelConverter;
import xcom.thoughtworks.xstream.converters.extended.SqlDateConverter;
import xcom.thoughtworks.xstream.converters.extended.SqlTimeConverter;
import xcom.thoughtworks.xstream.converters.extended.SqlTimestampConverter;
import xcom.thoughtworks.xstream.converters.extended.TextAttributeConverter;
import xcom.thoughtworks.xstream.converters.reflection.ExternalizableConverter;
import xcom.thoughtworks.xstream.converters.reflection.ReflectionConverter;
import xcom.thoughtworks.xstream.converters.reflection.ReflectionProvider;
import xcom.thoughtworks.xstream.converters.reflection.SelfStreamingInstanceChecker;
import xcom.thoughtworks.xstream.converters.reflection.SerializableConverter;
import xcom.thoughtworks.xstream.core.DefaultConverterLookup;
import xcom.thoughtworks.xstream.core.JVM;
import xcom.thoughtworks.xstream.core.MapBackedDataHolder;
import xcom.thoughtworks.xstream.core.ReferenceByIdMarshallingStrategy;
import xcom.thoughtworks.xstream.core.ReferenceByXPathMarshallingStrategy;
import xcom.thoughtworks.xstream.core.TreeMarshallingStrategy;
import xcom.thoughtworks.xstream.core.util.ClassLoaderReference;
import xcom.thoughtworks.xstream.core.util.CompositeClassLoader;
...
import xcom.thoughtworks.xstream.io.StatefulWriter;
import xcom.thoughtworks.xstream.io.xml.XppDriver;
import xcom.thoughtworks.xstream.mapper.AnnotationConfiguration;
import xcom.thoughtworks.xstream.mapper.ArrayMapper;
import xcom.thoughtworks.xstream.mapper.AttributeAliasingMapper;
import xcom.thoughtworks.xstream.mapper.AttributeMapper;
import xcom.thoughtworks.xstream.mapper.CachingMapper;
import xcom.thoughtworks.xstream.mapper.ClassAliasingMapper;
import xcom.thoughtworks.xstream.mapper.DefaultImplementationsMapper;
import xcom.thoughtworks.xstream.mapper.DefaultMapper;
import xcom.thoughtworks.xstream.mapper.DynamicProxyMapper;
import xcom.thoughtworks.xstream.mapper.FieldAliasingMapper;
import xcom.thoughtworks.xstream.mapper.ImmutableTypesMapper;
import xcom.thoughtworks.xstream.mapper.ImplicitCollectionMapper;
import xcom.thoughtworks.xstream.mapper.LocalConversionMapper;
import xcom.thoughtworks.xstream.mapper.Mapper;
import xcom.thoughtworks.xstream.mapper.MapperWrapper;
import xcom.thoughtworks.xstream.mapper.OuterClassMapper;
import xcom.thoughtworks.xstream.mapper.PackageAliasingMapper;
import xcom.thoughtworks.xstream.mapper.SystemAttributeAliasingMapper;
import xcom.thoughtworks.xstream.mapper.XStream11XmlFriendlyMapper;
 ...
 * <p/>
 * <p>
 * XStream contains a map of {@link xcom.thoughtworks.xstream.converters.Converter} instances, each
 ...
 * non-standard converters are supplied in the {@link xcom.thoughtworks.xstream.converters.extended}
 * package and you can create your own by implementing the
 * {@link xcom.thoughtworks.xstream.converters.Converter} interface.
 * </p>
 * <p/>
 * <p>
 * <hr>
 ...
 * {@link xcom.thoughtworks.xstream.converters.reflection.ReflectionConverter} as the fallback
 * converter.
 * </p>
 * <p/>
 * <p>
...
public class XStream {
    ...
    private static final String ANNOTATION_MAPPER_TYPE = "xcom.thoughtworks.xstream.mapper.AnnotationMapper";
    ...
    private Mapper buildMapper() {
        ...
        if (JVM.is15()) {
            mapper = buildMapperDynamically(
                "xcom.thoughtworks.xstream.mapper.EnumMapper", new Class[]{Mapper.class},
                new Object[]{mapper});
        }
    ...
    private Mapper buildMapperDynamically(String className, Class[] constructorParamTypes,
        ...
        try {
            ...
            throw new xcom.thoughtworks.xstream.InitializationException(
    ...
    protected void setupConverters() {
        ...
        if (JVM.is14()) {
            ...
            dynamicallyRegisterConverter(
                "xcom.thoughtworks.xstream.converters.extended.SubjectConverter",
                PRIORITY_NORMAL, new Class[]{Mapper.class}, new Object[]{mapper});
            dynamicallyRegisterConverter(
                "xcom.thoughtworks.xstream.converters.extended.ThrowableConverter",
            ...
            dynamicallyRegisterConverter(
                "xcom.thoughtworks.xstream.converters.extended.CurrencyConverter",
                PRIORITY_NORMAL, null, null);
            dynamicallyRegisterConverter(
                "xcom.thoughtworks.xstream.converters.extended.RegexPatternConverter",
                PRIORITY_NORMAL, new Class[]{Converter.class},
                new Object[]{reflectionConverter});
            dynamicallyRegisterConverter(
                "xcom.thoughtworks.xstream.converters.extended.CharsetConverter",
                PRIORITY_NORMAL, null, null);
        }
        ...
        if (JVM.is15()) {
            // late bound converters - allows XStream to be compiled on earlier JDKs
            dynamicallyRegisterConverter(
                "xcom.thoughtworks.xstream.converters.extended.DurationConverter",
                PRIORITY_NORMAL, null, null);
            dynamicallyRegisterConverter(
                "xcom.thoughtworks.xstream.converters.enums.EnumConverter", PRIORITY_NORMAL,
                null, null);
            dynamicallyRegisterConverter(
                "xcom.thoughtworks.xstream.converters.enums.EnumSetConverter", PRIORITY_NORMAL,
                new Class[]{Mapper.class}, new Object[]{mapper});
            dynamicallyRegisterConverter(
                "xcom.thoughtworks.xstream.converters.enums.EnumMapConverter", PRIORITY_NORMAL,
                new Class[]{Mapper.class}, new Object[]{mapper});
            dynamicallyRegisterConverter(
                "xcom.thoughtworks.xstream.converters.basic.StringBuilderConverter",
                PRIORITY_NORMAL, null, null);
            dynamicallyRegisterConverter(
                "xcom.thoughtworks.xstream.converters.basic.UUIDConverter", PRIORITY_NORMAL,
                null, null);
        }
    ...
    protected void setupImmutableTypes() {
        ...
        if (JVM.is14()) {
            ...
            Class type = jvm
                .loadClass("xcom.thoughtworks.xstream.converters.extended.CharsetConverter");
    ...
    public void alias(String name, Class type) {
        if (classAliasingMapper == null) {
            throw new xcom.thoughtworks.xstream.InitializationException("No "
     ...
     * </p>
     * 
     * @see #createObjectOutputStream(xcom.thoughtworks.xstream.io.HierarchicalStreamWriter,
     *      String)
     * @see #createObjectInputStream(xcom.thoughtworks.xstream.io.HierarchicalStreamReader)
     * @since 1.0.3
     */
