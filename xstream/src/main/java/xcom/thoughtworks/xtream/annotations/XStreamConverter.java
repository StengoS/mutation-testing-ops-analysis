 ...
 */
package xcom.thoughtworks.xstream.annotations;
 ...
 * <ul>
 * <li>{@link xcom.thoughtworks.xstream.mapper.Mapper}: The current mapper chain of the XStream
 * instance.</li>
 * <li>{@link ClassLoader}: The class loader used by the XStream instance to deserialize the
 * objects.</li>
 * <li>{@link xcom.thoughtworks.xstream.converters.reflection.ReflectionProvider}: The reflection
 ...
 * {@link xcom.thoughtworks.xstream.annotations.XStreamConverters}.</li>
 * </ul>
 * <p>
 * Note, the annotation matches a {@link ConverterMatcher}.
 * {@link xcom.thoughtworks.xstream.converters.ConverterMatcher} as well as
 * {@link xcom.thoughtworks.xstream.converters.SingleValueConverter} extend this interface. The
 * {@link xcom.thoughtworks.xstream.mapper.AnnotationMapper} can only handle these two
