...
def main():
    ...
    for run_id in range(1, 6):
        ...
        # Randomize ordering of test cases for removeNode() in SimulatorRemoveNodeTest.java
        test_cases_original = [1, 2, 3]
        ...
        # addNode() test cases' file name: SimulatorRemoveNodeTest; Unit test name: testRemoveNode<#>
        test_suite_info = get_cases_full_conditional_cov("-Dtest=SimulatorRemoveNodeTest#", "testRemoveNode", \
            test_cases_original, "removeNode", shuffled_cases, mute_print=False)
        ...
        mutations_info = parse_mutation_matrix("mutation_matrix/mutations.xml", test_cases_picked,
            mute_print=False, start_line=1468, end_line=1486)
